...
@mcp_tool(name="system_tools.get_sys_info", description="Retrieve OS, platform, and python environment details. Args: {}")
...
@mcp_tool(name="system_tools.get_env", description="Retrieve all environment variables. Args: {}")
def get_env() -> str:
