...
@mcp_tool(name="voice_tools.enable_voice_mode", description="Enable voice mode to initialize audio capture and speech recognition. Call this when the user says /voice. Args: {}")
...
@mcp_tool(name="/voice", description="Shorthand for voice mode initialization. Args: {}")
