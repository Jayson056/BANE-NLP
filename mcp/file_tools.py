...
@mcp_tool(name="file_tools.read_file", description="Read file contents. Args: {'path': 'path/to/file'}")
...
@mcp_tool(name="file_tools.write_file", description="Write content to a file. Args: {'path':'...', 'content':'...'}")
...
@mcp_tool(name="file_tools.write_file_b64", description="Write content to a file using Base64 encoding (bypasses JSON escaping issues). Args: {'path':'...', 'b64_content':'...'}")
...
@mcp_tool(name="file_tools.list_dir", description="List directory contents. Args: {'path':'...'}")
...
@mcp_tool(name="file_tools.rename", description="Rename or move a file/folder. Args: {'src': 'old/path', 'dst': 'new/path'}")
...
@mcp_tool(name="file_tools.move_file", description="Move a file or folder to a new location. Args: {'src': 'source/path', 'dst': 'destination/path'}")
...
@mcp_tool(name="file_tools.copy_file", description="Copy a file to a new location. Args: {'src': 'source/file.txt', 'dst': 'destination/file.txt'}")
...
@mcp_tool(name="file_tools.delete_file", description="Permanently delete a single file. Args: {'path': 'path/to/file.txt'}")
...
@mcp_tool(name="file_tools.create_dir", description="Create a directory. Args: {'path':'path/to/create'}")
...
@mcp_tool(name="file_tools.read_project_snapshot", description="Traversers a directory and stitches all text-based files into a single output string for whole-project analysis. Automatically ignores .git, node_modules, temp, logs, binaries, cache, etc. Args: {'path':'...dir...'}")
