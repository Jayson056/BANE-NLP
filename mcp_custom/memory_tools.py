...
@mcp_custom_tool(name="memory_tools.search_past_topics", description="Searches a user's database conversations for specific keywords. IMPORTANT: Provide your current chrome_profile (e.g. 'Profile 4') to isolate the search to your specific academic/professional persona, preventing topic hallucination across profiles.")
...
@mcp_custom_tool(name="memory_tools.query_ai_sessions", description="Queries database for recent AI operational sessions and average latency.")
...
@mcp_custom_tool(name="memory_tools.search_logs", description="Search the engine logs for specific errors or keywords (e.g., 'error', 'failed').")
...
@mcp_custom_tool(name="memory_tools.list_unique_keywords", description="Lists the most frequent words/topics used in previous conversations to help the AI know what topics are available for recall.")
