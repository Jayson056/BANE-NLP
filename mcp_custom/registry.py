...
class MCPRegistry:
    ...
    def _find_tools_in_module(self, module, modname: str):
        """Find all @mcp_custom_tool decorated functions in a module."""
    ...
    def register_dynamic_tool(self, tool_name: str, code: str, description: str = "") -> str:
        ...
        try:
            ...
            imports = "from mcp_custom.mcp_registry import mcp_custom_tool\n"
...
# Expose @mcp_custom_tool decorator for convenience
mcp_custom_tool = mcp_custom_tool
