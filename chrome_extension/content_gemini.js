...
(function () {
  ...
  let sentImageFingerprints = new Set(); // Global tracker using canvas fingerprints to prevent recycling old images

  /**
   * Generate a fast content-based fingerprint of an image using a 16x16 canvas thumbnail.
   * This is immune to blob URL changes — it identifies image CONTENT, not URL.
   */
  function getImageFingerprint(img) {
    try {
      ...
      // Get raw pixel data as a compact string fingerprint
      ...
      // Canvas tainted by CORS — fallback to URL
